...
/**
    @title DYNAMO Curve Deposit Zap
    @notice Deposits tokens into Curve and stakes LP tokens into Curve/Convex via Dynamo
...
contract CurveDepositZap is Ownable {
    ...
    constructor(IDynamoVault _vault, address[2][] memory _basePools) {
        vault = _vault;
    ...
    /**
        ...
        @param depositToken Address of Dynamo `CurveDepositToken` or `ConvexDepositToken` deployment
        ...
        @param receiver Address to deposit into Dynamo on behalf of
